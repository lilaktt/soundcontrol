...
public class SoundLookupRenderer {
    ...
    public static void render(GuiGraphicsExtractor context) {
        ...
        context.text(font, "\u00A7e\u00A7l" + header, startX, startY - 12, 0xFFFFAA00, true);
        ...
        for (int i = 0; i < currentSounds.size(); i++) {
            ...
            if (colonIdx > 0) {
                ...
                context.text(font, action, startX, y, 0xFF88CCFF, true);
                context.text(font, soundId, startX + font.width(action), y, 0xFFCCCCCC, true);
            } else {
                context.text(font, line, startX, y, 0xFFAAAAAA, true);
            }
        }
    }
}
