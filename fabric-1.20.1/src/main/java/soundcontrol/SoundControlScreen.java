...
int buttonWidth = 60;
        ...
        this.addDrawableChild(net.minecraft.client.gui.widget.ButtonWidget.builder(Text.literal("🕒"), button -> {
            this.client.setScreen(new RecentSoundsPickerScreen(this));
        }).dimensions(this.width - 24, this.height - 24, 20, 20).tooltip(net.minecraft.client.gui.tooltip.Tooltip.of(Text.translatable("text.soundcontrol.recent_sounds"))).build());
