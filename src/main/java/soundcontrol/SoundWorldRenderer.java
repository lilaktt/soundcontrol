...
public class SoundWorldRenderer {
    ...
    public static class SoundEvent3D {
        ...
        public double smoothX, smoothY, smoothZ;

        public SoundEvent3D(SoundInstance sound, String soundId) {
            this.sound = sound;
            this.soundId = soundId;
            this.createdAt = System.currentTimeMillis();
            this.smoothX = sound.getX();
            this.smoothY = sound.getY();
            this.smoothZ = sound.getZ();
        }
    }
    ...
    public static void render(DrawContext context) {
        ...
        Matrix4f projMatrix = client.gameRenderer.getBasicProjectionMatrix(client.options.getFov().getValue().floatValue());
