...
public class SoundControlScreen extends Screen {
    ...
    public void setInitialViewMode(int viewMode) {
...
int buttonWidth = 60;
        ...
        this.addDrawableChild(ButtonWidget.builder(Text.literal("\uD83D\uDD52"), button -> {
            this.client.setScreen(new RecentSoundsPickerScreen(this));
        }).dimensions(this.width - 26, this.height - 28, 20, 20).tooltip(net.minecraft.client.gui.tooltip.Tooltip.of(net.minecraft.text.Text.translatable("text.soundcontrol.recent.title"))).build());

        this.setInitialFocus(this.searchBox);
        
        if (this.initialViewMode >= 0) {
        ...
        if (!this.initialSearch.isEmpty()) {
            this.searchBox.setText(this.initialSearch);
            this.initialSearch = "";
        }
