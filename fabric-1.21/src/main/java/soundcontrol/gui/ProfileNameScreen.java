...
public class ProfileNameScreen extends Screen {
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == GLFW.GLFW_KEY_ENTER && this.confirmButton.active) { confirm(); return true; }
        if (keyCode == GLFW.GLFW_KEY_ESCAPE) { this.client.setScreen(this.parent); return true; }
